    ...
    <div className=' h-[12vh] bg-white'>
      <div className=' sm:w-[90%] w-[95%] mx-auto flex h-[100%] items-center justify-between'>
        ...
        <div className=' flex items-center space-x-4'>
          ...
          <button className=' sm:px-6 sm:py-3 px-4 py-2 text-[14px] sm:text-[16px] text-white bg-orange-600 transition-all duration-200 hover:bg-green-600 flex items-center rounded-md'>
